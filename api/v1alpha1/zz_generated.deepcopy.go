...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TestRunDefaulter) DeepCopyInto(out *TestRunDefaulter) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TestRunDefaulter.
func (in *TestRunDefaulter) DeepCopy() *TestRunDefaulter {
	if in == nil {
		return nil
	}
	out := new(TestRunDefaulter)
	in.DeepCopyInto(out)
	return out
}
