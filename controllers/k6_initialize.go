...
var (
	...
	errMaxInstances = fmt.Errorf("number of instances > number of VUs")
)
...
func InitializeJobs(ctx context.Context, log logr.Logger, k6 *v1alpha1.K6, r *K6Reconciler) (res ctrl.Result, err error) {
	...
	hasFinished, err := initJobHasFinalized(ctx, log, k6, r)
...
func initJobHasFinalized(ctx context.Context, log logr.Logger, k6 *v1alpha1.K6, r *K6Reconciler) (bool, error) {
	var (
